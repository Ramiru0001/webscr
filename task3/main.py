    ...
    def popup_delete():
        ...
        #現在あるポップアップを入手する
            ...
            for i in range(len(all_pop)):
                ...
                elements1=all_pop[i].find_elements(By.CLASS_NAME,'_paragraphXS_e96vf_103')
                elements2=all_pop[i].find_elements(By.CLASS_NAME,'_paragraphS_e96vf_92')
                elements3=all_pop[i].find_elements(By.CLASS_NAME,'_paragraphM_e96vf_81')
                ...
                elif len(elements3)!=0:
                    #ゲーム復帰のpop
                    path='../div[3]/button[2]'
                    elements3[0].find_element(By.XPATH,path).click()
